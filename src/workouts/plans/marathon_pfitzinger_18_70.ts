...
export default {
  ...
  workouts: [
    ...
    {
      description: "Recovery + speed #6D w/6x100m strides a.m. #4D p.m.",
      totalDistance: 10,
    },
    {
      description: "Recovery #5D",
    ...
    {
      description:
        "VO₂ Max #10D w/ 6x1,000m @ 5K race pace; jog 50 to 90% interval time between",
      totalDistance: 10,
    },
    {
      description: "Medium-long run #15D",
    ...
    {
      description:
        "VO₂ Max #11D w/ 5x1,200m @ 5K race pace; jog 50 to 90% interval time between",
      totalDistance: 11,
    },
    {
      description: "Medium-long run #14D",
    ...
    { description: "Rest or cross-training", totalDistance: 0 },
    {
      description: "Recovery + speed #7D w/ 8x100m strides",
      totalDistance: 7,
    },
    {
      description: "Medium-long run #12D",
    ...
    {
      description:
        "VO₂ Max #8D w/ 3x1,600m @ 5K race pace; jog 50 to 90% interval time between",
      totalDistance: 8,
    },
    {
      description: "Recovery #5D",
    ...
    {
      description: "Recovery + speed #6D w/ 8x100m strides",
      totalDistance: 6,
    },
    {
      description: "Medium-long run #13D",
